		...
		<div class="page-content">
			...
			<!-- BEGIN FORM-->
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<h3 class="form-section">Thông tin bài viết</h3>
												<div class="row">
												<div class="col-md-3">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<textarea rows="" cols="" id="des" name="des" style="width: 820px;height: 175px">mô tả ngắn</textarea>
                      
																<span class="help-block">
																Nhập mô tả ngắn của bài viết </span>
															</div>
														</div>
													</div>
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<textarea rows="" cols="" id="content" name="content" style="width: 820px;height: 175px">nội dung</textarea>
                      
																<span class="help-block">
																Nhập nội dung của bài viết </span>
															</div>
														</div>
													</div>
